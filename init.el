...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org2blog metaweblog xml-rpc projectile-rails rake f s inf-ruby inflections helm-projectile helm helm-core popup typo rvm rubocop enh-ruby-mode org-beautify-theme org-bullets hydra pkg-info epl magit magit-popup git-commit with-editor dash async projectile use-package))))
(custom-set-faces
...
;; Taking the org2blog instructions from http://vxlabs.com/2014/05/25/emacs-24-with-prelude-org2blog-and-wordpress/

;; but following the org2blog README and using auth-source instead of netrc: https://github.com/punchagan/org2blog/commit/52be89507c337e5f74be831ca563a8023e0ec736

;; Expects an ~/.authinfo file of the form: machine {my-machine-name} login {my-elogin} password {my-password}
